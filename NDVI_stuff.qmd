...
# Might need if things don't work
fakeData <- tribble(
  ~x, ~y, ~NDVI,        ~date, ~field,
  1,   1,    1, ymd("2024-01-31"),      "z",
  1,   1,    1, ymd("2024-02-23"),      "z",
  1,   1,    1, ymd("2024-03-16"),      "z",
  1,   1,    1, ymd("2024-04-05"),      "z",
  1,   1,    1, ymd("2024-05-27"),      "z",
  1,   1,    1, ymd("2024-06-20"),      "z",
  NA,   NA,    NA, ymd("2024-07-16"),      "z",
  1,   1,    1, ymd("2024-08-30"),      "z",
  1,   1,    1, ymd("2024-09-27"),      "z",
  1,   1,    1, ymd("2024-10-26"),      "z",
  1,   1,    1, ymd("2024-11-09"),      "z",
  1,   1,    1, ymd("2024-12-05"),      "z"
)
...
ggsave(filename = "prelimPlotJuly.png")
```
